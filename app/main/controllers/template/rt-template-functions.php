...
function rtmedia_admin_premium_page( $page ) {
	if ( 'rtmedia-premium' == $page ){
		...
		<div class="premium-page-container">
			...
			<div class="row">
				<div class="columns large-1 rtm-premium-icon-pro"><i class="dashicons dashicons-heart rtmicon-3x rtmicon"></i></div>
			...
			<div class="row">
				<div class="columns large-1 rtm-premium-icon-pro"><i class="dashicons dashicons-tag rtmicon-3x rtmicon"></i></div>
				<div class="columns large-10">
			...
			<div class="row">
				<div class="columns large-1 rtm-premium-icon-pro"><i class="dashicons dashicons-sort rtmicon-3x rtmicon"></i></div>
				<div class="columns large-10">
			...
			<div class="row">
				<div class="columns large-1 rtm-premium-icon-pro"><i class="dashicons dashicons-admin-links rtmicon-3x rtmicon"></i></div>
				<div class="columns large-10">
			...
			<div class="row">
				<div class="columns large-1 rtm-premium-icon-pro"><i class="dashicons dashicons-upload rtmicon rtmicon-3x"></i></div>
				<div class="columns large-10">
			...
			<div class="row">
				<div class="columns large-1 rtm-premium-icon-pro"><i class="dashicons dashicons-edit rtmicon-3x rtmicon"></i></div>
				<div class="columns large-10">
			...
			<div class="row">
				<div class="columns large-1 rtm-premium-icon-pro"><i class="rtmicon-thumbs-up rtmicon-3x rtmicon-fw"></i></div>
				<div class="columns large-10">
			...
			<div class="row">
				<div class="columns large-1 rtm-premium-icon-pro"><i class="dashicons dashicons-awards rtmicon-3x rtmicon"></i></div>
				<div class="columns large-10">
			...
			<div class="row">
				<div class="columns large-1 rtm-premium-icon-pro"><i class="dashicons dashicons-shield rtmicon-3x rtmicon"></i></div>
				<div class="columns large-10">
			...
			<div class="row">
				<div class="columns large-1 rtm-premium-icon-pro"><i class="dashicons dashicons-star-filled rtmicon rtmicon-3x"></i></div>
				<div class="columns large-10">
